...
import type { ProjectOverviewCardFields } from "@/src/components/pages/project-overview-view"
import {
  ProjectOverviewEmptyView,
  ProjectOverviewNewProjectView,
  ProjectOverviewPersistedView,
} from "@/src/components/pages/project-overview-view"
...
export function ProjectOverview({
  ...
  if (isNewProject && project) {
    return (
      <ProjectOverviewNewProjectView
        project={project}
        onOpenCommunicationCenter={() => setShowChat(true)}
      />
    )
  }
  ...
  return <ProjectOverviewEmptyView />
}
